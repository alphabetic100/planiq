        ...
        children: [
          ...
          ListTile(
            leading: CircleAvatar(
              ...
              backgroundImage: user.tasks.isNotEmpty
                  ? user.tasks[0].user.profileImage.isNotEmpty
            ...
            title: Text.rich(
              TextSpan(
                children: [
                  TextSpan(
                    text: user.tasks.isNotEmpty ? user.tasks[0].user.name : "",
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: 16.sp,
