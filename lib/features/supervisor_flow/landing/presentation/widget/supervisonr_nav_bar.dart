...
class SupervisonrNavBar extends StatelessWidget {
  SupervisonrNavBar({super.key});
  ...
  final SupervisorLandingController controller =
      Get.find<SupervisorLandingController>();
  @override
